...
const HeaderText = (props) => {
  return (
    <div className="items-center text-[#1d1c1d] flex flex-col text-[15px] leading-[22px]">
      <div className="text-[#1d1c1d] text-center text-[48px] font-[700] leading-[46px] mb-10">
        {props.title}
      </div>
    </div>
  );
